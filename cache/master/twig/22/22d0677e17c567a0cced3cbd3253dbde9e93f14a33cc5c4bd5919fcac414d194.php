...
/* sami.js.twig */
class __TwigTemplate_905b66f4e5c51bc4919f2d68356554ebd814470303500f1e17f4554228407fc1 extends Twig_Template
{
    private $source;
...
(function(root) {
    ...
    var treeHtml = '";
        ...
        })()), 'config', array(0 => 'default_opened_level'), 'method'), 0), array("'" => "\\'", '
' => ''));
        echo "';
        ...
        try {
            ...
            if (twig_get_attribute($this->env, $this->source, (isset($context['class']) || array_key_exists('class', $context) ? $context['class'] : (function () {
                ...
                foreach ($context['_seq'] as $context['_key'] => $context['meth']) {
                    ...
                    echo '", "doc": "';
                    echo twig_escape_filter($this->env, json_encode($this->extensions['Sami\Renderer\TwigExtension']->parseDesc($context, twig_get_attribute($this->env, $this->source, $context['meth'], 'shortdesc', array()), (isset($context['class']) || array_key_exists('class', $context) ? $context['class'] : (function () {
    ...
    <ul>';
            ...
            foreach ($context['_seq'] as $context['_key'] => $context['element']) {
                ...
                if (twig_get_attribute($this->env, $this->source, $context['element'], 2, array(), 'array')) {
                    ...
                    })()), 'config', array(0 => 'simulate_namespaces'), 'method')) {
                        echo '<a href="';
                    ...
                    <div class="bd">
                        ';
                    // line 236
                    echo $context['__internal_abe917f28939a73d7c6553bae73fe7546c6534dc84cc1e86ef2ae60b26089e85']->macro_element(twig_get_attribute($this->env, $this->source, $context['element'], 2, array(), 'array'), (isset($context['opened']) || array_key_exists('opened', $context) ? $context['opened'] : (function () {
...
{% endmacro %}
", 'sami.js.twig', 'phar:///home/albemumo/Workspace/CreativeHotHouse/blog/sami.phar/Sami/Resources/themes/default/sami.js.twig');
    }
}
